...
{
public:
    XArch(XArchEval *adopted)
        : std::runtime_error(adopted->eval())
    {
        delete adopted;
    }
    XArch(const std::string &msg)
...
#define XARCH_SUBCLASS(name_, super_)                                                                                                                          \
    ...
    {                                                                                                                                                          \
    public:                                                                                                                                                    \
        name_(XArchEval *adoptedEvaluator)                                                                                                                     \
            : super_(adoptedEvaluator)                                                                                                                         \
        {                                                                                                                                                      \
        }                                                                                                                                                      \
        name_(const std::string &msg)                                                                                                                          \
            : super_(msg)                                                                                                                                      \
        {                                                                                                                                                      \
        }                                                                                                                                                      \
    }
