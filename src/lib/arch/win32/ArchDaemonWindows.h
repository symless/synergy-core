...
public:
    ...
    */
    ...
    virtual void installDaemon(const char *name, const char *description, const char *pathname, const char *commandLine, const char *dependencies);
...
private:
    ...
    {
    public:
        XArchDaemonRunFailed(int result)
            : m_result(result)
        {
        }
