...
public:
    ...
    */
    void addKeyAliasEntry(KeyID targetID,
                          SInt32 group,
    ...
    */
    virtual const KeyItem *mapKey(Keystrokes &keys,
                                  KeyID id,
                                  SInt32 group,
...
private:
    ...
    // resulting modifier state.
    bool keysForModifierState(KeyButton button,
                              SInt32 group,
                              ModifierToKeys &activeModifiers,
                              KeyModifierMask &currentState,
    ...
    void addKeystrokes(EKeystroke type, const KeyItem &keyItem, ModifierToKeys &activeModifiers, KeyModifierMask &currentState, Keystrokes &keystrokes) const;
