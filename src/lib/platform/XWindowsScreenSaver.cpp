    ...
    , m_events(events)
{
    ...
    m_events->adoptHandler(Event::kTimer, this, new TMethodEventJob<XWindowsScreenSaver>(this, &XWindowsScreenSaver::handleDisableTimer));
}
...
bool XWindowsScreenSaver::isXScreenSaver(Window w) const
{
    ...
    Atom type;
    return (XWindowsUtil::getWindowProperty(m_display, w, m_atomScreenSaverVersion, NULL, &type, NULL, False) && type == XA_STRING);
}
