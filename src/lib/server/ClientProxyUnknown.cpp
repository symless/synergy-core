    ...
    , m_events(events)
{
    ...
    m_events->adoptHandler(Event::kTimer, this, new TMethodEventJob<ClientProxyUnknown>(this, &ClientProxyUnknown::handleTimeout, NULL));
...
void ClientProxyUnknown::addProxyHandlers()
{
    ...
    m_events->adoptHandler(m_events->forClientProxy().ready(), m_proxy, new TMethodEventJob<ClientProxyUnknown>(this, &ClientProxyUnknown::handleReady));
