...
namespace std {
template<>
struct iterator_traits<deskflow::server::Config>
{
...
public:
    ...
    public:
        ...
        explicit const_iterator(const internal_const_iterator &i)
            : m_i(i)
        {
        }
    ...
    */
    bool connect(const String &srcName, EDirection srcSide, float srcStart, float srcEnd, const String &dstName, float dstStart, float dstEnd);
...
private:
    ...
    void parseAction(ConfigReadContext &, const String &action, const std::vector<String> &args, InputFilter::Rule &, bool activate);
...
public:
    ...
    void parseNameWithArgs(const String &type, const String &line, const String &delim, String::size_type &index, String &name, ArgList &args) const;
